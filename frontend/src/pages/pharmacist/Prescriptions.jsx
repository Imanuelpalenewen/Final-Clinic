...
export default function PharmacistPrescriptions() {
  ...
  const handleProcess = async (id) => {
    if (!confirm('Proses resep ini? Stok obat akan dikurangi.')) return;

    try {
      await axios.put(`/queue/${id}/pharmacy`);
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-800 mb-6">Resep Masuk</h1>
